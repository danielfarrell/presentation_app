defmodule PresentationApp.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule PresentationApp.MyChannel do
        use PresentationApp.Web, :channel
        alias PresentationApp.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :presentation_app,
                        pubsub_server: PresentationApp.PubSub
end
